    ...
    export const GoalsPage: React.FC = () => {
        ...
        const mapGoalFromApi = (goal: any): Goal => {
            const raw = goal?.targetDate ? new Date(goal.targetDate) : null

            const normalized =
                raw !== null
                    ? new Date(raw.getTime() + raw.getTimezoneOffset() * 60 * 1000)
                    : null
